    ...
    <div className="flex h-screen bg-white">
      ...
      >
        ...
        <nav className="flex-1 p-3">
          <button className="w-full flex items-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-lg mb-2">
          ...
          <button className="w-full flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg mb-2">
            ...
            {!sidebarCollapsed && <span>Client List</span>}
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg mb-2">
            <FileText className="w-5 h-5" />
        ...
        <div className="flex-1 overflow-auto">
          <div className="flex flex-col lg:flex-row gap-6 p-6">
            ...
            <div className="w-full lg:w-3/5">
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                  <button className="bg-gray-900 text-white w-full sm:w-64 py-2.5 rounded-lg hover:bg-gray-800 transition">
                    Previous
                  </button>
                  <button className="bg-gray-900 text-white w-full sm:w-64 py-2.5 rounded-lg hover:bg-gray-800 transition">
                    Next
            ...
            <div className="w-full lg:w-2/5">
              <div className="rounded-lg border border-gray-200 p-6 sticky top-6 bg-white">
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                  <div className="flex flex-col items-center md:items-start">
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center mb-3">
                      <svg
                        viewBox="0 0 100 100"
                    ...
                    <div className="text-sm">
                      ...
                      <p className="font-medium mt-1">07526</p>
                    </div>
                  </div>

                  <div className="flex-1 text-sm text-right space-y-1">
                    <p className="text-gray-600">
                      19th Street, Mckinney Walker
                    </p>
                    <p className="text-gray-600">Jaddah</p>
                    <p className="text-gray-600">+1-0281-856-6521</p>
                    <div className="pt-2">
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="flex gap-4 mb-6">
              <button className="flex-1 h-24 border border-gray-300 rounded-lg flex flex-col items-center justify-center hover:bg-gray-50">
